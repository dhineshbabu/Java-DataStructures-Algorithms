...
public class Prob_LargestRectWithAll1S  {
    /*
    idea is to calculate the acc sum for each row and send the row to greaterElment() method and find the max of result
