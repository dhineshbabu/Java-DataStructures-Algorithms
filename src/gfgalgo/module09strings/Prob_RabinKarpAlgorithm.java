...
public class Prob_RabinKarpAlgorithm {
    /*
    Compute the hash value for the pattern
    then compare the pattern with each window of the text

    Compute the hash value using sliding window technique
    hash functions using weighted sum using a variable (d)
